...
import talpiot.mb.magdadmilbat.R;
...
//            int grade =repsSuccess/max;
            TrainingData exerciseObj = new TrainingData(dateObj.toString(), timeObj, "נשיפה עמוקה", repsSuccess, duration, formatDouble2db(repDuration), format2db(repMaxHeight),balldata, targetrep);
            HistoryDatabaseManager dbObj = new HistoryDatabaseManager(Feedback.this);
